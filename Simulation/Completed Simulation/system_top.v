...
module system_top #(
    ...
    input  wire        cam_vsync,   // ??ng b? khung hình (Frame sync)
    ...
    // =========================================================================
    // 1. T?O XUNG VÀ C?U HÌNH CAMERA (SCCB)
    // =========================================================================
    camera_xclk_24m #(
    ...
    // =========================================================================
    // 4. B? ??M T?A ?? & TÌM KHUNG BAO (BOUNDING BOX)
    // =========================================================================
    ...
    // Ch?t (Latch) t?a ?? cu?i cùng khi k?t thúc 1 Frame hình
    ...
    always @(posedge sys_clk or posedge sys_rst) begin
        if (sys_rst) begin
            ...
            // N?u có v?t th? (xmax > xmin), gán c? h?p l? (Valid)
    ...
    // T?m th?i gán màu ?en cho VGA (Do ch?a có b? nh? RAM l?u ?nh xu?t màn hình)
